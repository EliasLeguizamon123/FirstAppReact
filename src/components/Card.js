import {
  ...
  function Card(props) {
      const { title, difficulty, path, views, likes, disLikes, description} = props;
    return (
        <Container maxWidth="sm" p={50}>
        ...
        <Box
          ...
          <Box p="6">
            ...
            {props.tags.map(tag =>(
                <Badge key={tag} rounded="full" px="2" fontSize="0.8em" colorScheme="yellow" mr="3">
                  {tag}
                </Badge>
            ))}
            </Box>
